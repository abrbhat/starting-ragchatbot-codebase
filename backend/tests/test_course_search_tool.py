...
class TestCourseSearchToolExecute:
    ...
    def test_execute_returns_formatted_results_on_success(self, course_search_tool, mock_vector_store, sample_search_results):
    ...
    def test_execute_returns_error_message_on_search_error(self, course_search_tool, mock_vector_store, error_search_results):
        """Test that execute returns error message when search fails."""
        mock_vector_store.search.return_value = error_search_results

        result = course_search_tool.execute(query="anything", course_name="NonExistentCourse")

        assert "No course found matching 'NonExistentCourse'" in result

    def test_execute_returns_no_content_message_on_empty_results(self, course_search_tool, mock_vector_store, empty_search_results):
    ...
    def test_execute_empty_results_with_course_filter_shows_course_name(self, course_search_tool, mock_vector_store, empty_search_results):
    ...
    def test_execute_empty_results_with_lesson_filter_shows_lesson_number(self, course_search_tool, mock_vector_store, empty_search_results):
    ...
    def test_execute_populates_last_sources(self, course_search_tool, mock_vector_store, sample_search_results):
    ...
    def test_execute_sources_include_lesson_url_when_available(self, course_search_tool, mock_vector_store, sample_search_results):
        ...
        has_url = any("https://" in source for source in course_search_tool.last_sources)
...
class TestCourseSearchToolFormatResults:
    ...
    def test_format_results_includes_course_header(self, course_search_tool, sample_search_results):
    ...
    def test_format_results_includes_lesson_number_in_header(self, course_search_tool, sample_search_results):
    ...
    def test_format_results_separates_multiple_results(self, course_search_tool, sample_search_results):
